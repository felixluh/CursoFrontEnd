...
export class VagasService { // Serviço responsavel por acessar a Api e manter a logica de negócio
 private apiUrl = "http://localhost:3007/vagas"; //endereço da Api
  ...
  getVagas():Observable<Vaga[]> { //observable é um tipo de dado que permite rabalhar com assincronismo
